...
func (c *OrderJishiController) Get() {
	...
	body, err := HttpGet(fmt.Sprintf("http://192.168.3.9:10088/guoshi/api/v1/user/user-pro?number=%s", userNumber))
	if err != nil {
		return
	}
	var data JiShiResp
	...
	body, err = HttpGet("http://192.168.3.9:10088/guoshi/api/v1/project/list")
	if err != nil {
		return
	}
...
func (c *OrderQianTaiController) Get() {
	...
	body, err := HttpGet(fmt.Sprintf("http://192.168.3.9:10088/guoshi/api/v1/order/user?number=%s", userNumber))
	if err != nil {
		return
	}
	var data OrderResp
...
func (c *OrderIndexController) Get() {
	...
	body, err := HttpGet(fmt.Sprintf("http://192.168.3.9:10088/guoshi/api/v1/user/user/login?userNumber=%s&pwd=%s", userNumber, pwd))
	if err != nil {
		return
	}
	var data UserResp
...
func (c *JiShiPayController) Get() {
	...
	body, err := HttpGet(fmt.Sprintf("http://192.168.3.9:10088/guoshi/api/v1/order/wage?begin=%s&end=%s&userNumber=%s", strconv.Itoa(int(begin)), strconv.Itoa(int(end)), userNumber))
	if err != nil {
		return
	}
